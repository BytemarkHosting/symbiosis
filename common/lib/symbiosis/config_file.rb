...
module Symbiosis
  ...
  class ConfigFile
    ...
    def managed?
      ...
      if (snippet.last.is_a?(String) and snippet.last.chomp =~ /^#{self.comment_char} Checksum MD5 ([a-f0-9]{32,32})$/) or
        (snippet.any?{|l| l.is_a?(String) and self.comment_char+" DO NOT EDIT THIS FILE - CHANGES WILL BE OVERWRITTEN" == l.chomp})
        true
      else
        false
      end
